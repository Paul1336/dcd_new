...
# Hyperparameters mirroring run_iphyre_v_sfl.py, with ACCEL-specific additions.
PARAMS = {
    # Env
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method',   type=str, default='Iphyre-V-ACCEL')
    parser.add_argument('--exp_name', type=str, default='iphyre_v_accel')
