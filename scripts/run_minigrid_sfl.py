...
PARAMS = {
    ...
    # Evaluation (no test envs for multigrid by default)
    'test_env_names':                       '',
    'test_interval':                        20,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method',   type=str, default='MultiGrid-SFL')
    parser.add_argument('--exp_name', type=str, default='minigrid_sfl')
