"""
Quick smoke-test for the iphyre-v-accel pipeline.
...
PLR scoring → ACCEL editing → eval) can be verified in a few minutes on any
machine.

Usage:
    cd dcd_new
    python scripts/run_iphyre_v_accel_test.py [--device cuda:0] [--log_dir ~/logs/dcd/]
"""
...
PARAMS = {
    ...
    # PLR  (buffer size reduced for smoke-test)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method',   type=str, default='Iphyre-V-ACCEL-test')
    parser.add_argument('--exp_name', type=str, default='iphyre_v_accel_test')
