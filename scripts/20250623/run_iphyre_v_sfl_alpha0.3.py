...
def get_commands_groups():
    ...
    json_list = [
        ...
        # ('iphyre/iphyre_v_robust_plr_10k.json', 'Iphyre-V-Robust-PLR-10k'),
        # ('iphyre/iphyre_v_accel_10k.json', 'Iphyre-V-Accel-10k'),
        ('iphyre/iphyre_v_sfl_alpha0.3.json', 'Iphyre-V-SFL-0.3'),
    ]
    ...
    for json_path, method in json_list:
        args = argparse.Namespace(
            ...
            xvfb=False,
            method=method,
            exp_name=f'ued_iphyre_all_reproduce_0622',
            device="cuda:0",
