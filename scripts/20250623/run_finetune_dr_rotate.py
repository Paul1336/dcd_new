...
def get_commands_groups():
    ...
    json_list = [
        ...
        ('iphyre/iphyre_procedural_rotate_on_dr.json', 'Iphyre-ProceduralRotate-on-DR'),
        # ('iphyre/iphyre_procedural_rotate_on_v_sfl.json', 'Iphyre-ProceduralRotate-on-V-SFL'),
    ]
