...
def load_vlm_gen_tasks_solvable(task_dir_list, should_check_solvable):
    env_ids = []
...
from env.benchmark.iphyre.datapath import (
    vlm_10k_task_dir_list,
    vlm_4k_task_dir_list,
    vlm_10k_claude_task_dir_list,
    vlm_10k_gemini_task_dir_list,
)
...
class IphyreAdversarialVLM4kEnv(IphyreAdversarialEnv):
    def __init__(self, config={}, seed=None, random_z_dim=10, reset_random_after_episode=False, env_names=[]):
        ...
        self.subsampled_env_ids = list(env_names)
        self.subsampled_task_info_dict = {
            env_id: task_info_dict[env_id]
            for env_id in self.subsampled_env_ids
            if env_id in task_info_dict
        }
    ...
    def reset_to_level(self, level):
        if '@@' not in str(level):
            self.level_seed = level
            self.task_config = PARAS[level]
            return self.reset_agent()
        return super().reset_to_level(level)
...
_MODULE = 'env.benchmark.iphyre.adversarial'

gym_register(id='Iphyre-Adversarial-v0',
             entry_point=_MODULE + ':IphyreAdversarialEnv',
             max_episode_steps=2000)

gym_register(id='Iphyre-AdversarialVLM4k-v0',
             entry_point=_MODULE + ':IphyreAdversarialVLM4kEnv',
             max_episode_steps=2000)

gym_register(id='Iphyre-AdversarialVLM10k-v0',
             entry_point=_MODULE + ':IphyreAdversarialVLM10kEnv',
             max_episode_steps=2000)

gym_register(id='Iphyre-AdversarialClaudeVLM10k-v0',
             entry_point=_MODULE + ':IphyreAdversarialClaudeVLM10kEnv',
             max_episode_steps=2000)

gym_register(id='Iphyre-AdversarialGeminiVLM10k-v0',
             entry_point=_MODULE + ':IphyreAdversarialGeminiVLM10kEnv',
             max_episode_steps=2000)

gym_register(id='Iphyre-AdversarialProceduralRotate-v0',
             entry_point=_MODULE + ':IphyreAdversarialProceduralRotateEnv',
             max_episode_steps=2000)

gym_register(id='Iphyre-AdversarialProceduralShift-v0',
             entry_point=_MODULE + ':IphyreAdversarialProceduralShiftEnv',
             max_episode_steps=2000)

gym_register(id='Iphyre-Game-v0',
             entry_point=_MODULE + ':IphyreGameEnv',
             max_episode_steps=2000)

gym_register(id='IphyreAdversarialHandDesignBlockAngleEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignBlockAngleEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignBlockAngleHardEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignBlockAngleHardEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignBlockNoGapEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignBlockNoGapEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignBlockOrderEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignBlockOrderEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignConfuseEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignConfuseEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignDoubleEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignDoubleEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignDownEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignDownEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignHighBallEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignHighBallEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignHighGapEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignHighGapEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignOutsideEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignOutsideEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignReverseEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignReverseEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignRightEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignRightEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignSkipGapEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignSkipGapEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignSkipGapHardEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignSkipGapHardEnv',
             max_episode_steps=2000)
gym_register(id='IphyreAdversarialHandDesignSwapEnv-v0',
             entry_point=_MODULE + ':IphyreAdversarialHandDesignSwapEnv',
             max_episode_steps=2000)
