...
# Figure 9 in the paper, the Easy Init row
PARAM_RANGES_EASY = {
...
class BipedalWalkerAdversarialEnv(BipedalWalkerCustom):
    ...
    def step_adversary(self, action):
        ...
        # Why the reward is 0? 
        # This is because in adversarial_runner's `env_return = self._compute_env_return(agent_info, adversary_agent_info)`
        # The adversary_env's reward should be computed based on the return of protagonist and antagonist's return difference.
        # So the actual reward will be updated via `adversary_env.storage.replace_final_return(env_return)`
        return obs, 0, done, {}
