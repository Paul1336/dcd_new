...
def collect_play_all(player_name, max_episode, save_path):
    for game in GAMES:
        demo = IPHYRE(game)
        demo.collect_while_play(
            player_name=player_name, max_episode=max_episode, save_path=save_path
        )
